...
出于巩固知识温故知新的目的，以及梳理一下长期以来的个人笔记，决定重新翻新一下博客。由于本人不熟悉前端开发所以先找一种简单容易上手框架。折腾了一番最终选择了`GitHub Pages + Hexo + Next`。为了方便以后折腾和帮助有同样需求的人，在此记录一下本博客的搭建方法。并且在以后的使用和学习中发现新的知识点也会持续对此笔记进行修正和补充。
<!-- more -->
